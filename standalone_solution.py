...
<body>
    <div class="container">
        ...
        <div class="options">
            <div class="option" onclick="window.location.href='/plant_identification'">
                <h2>Plant Species Identification</h2>
                <p>Identify plant species from images</p>
            </div>
            
            <div class="option" onclick="window.location.href='/chatbot'">
...
if __name__ == '__main__':
    ...
    print(f"Starting Agritech Hub on {url}")
